...
public class IntelligenceHomeAdapter extends BaseQuickAdapter<HomeIntelligenceEntity.list, BaseViewHolder> {
    public IntelligenceHomeAdapter(@Nullable List<HomeIntelligenceEntity.list> data) {
        super(R.layout.item_recycler_home_intelligence, data);
    }

    @Override
    protected void convert(BaseViewHolder helper,final HomeIntelligenceEntity.list item) {
