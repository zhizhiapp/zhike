...
public class LinearLayoutColorDecoration extends RecyclerView.ItemDecoration {
    ...
    //mJournaRecycler.addItemDecoration(new LinearLayoutColorDecoration(LinearLayoutManager.VERTICAL, getResources().getDimensionPixelSize(R.dimen.x1), Color.BLACK, 1));
    public LinearLayoutColorDecoration(@LinearLayoutCompat.OrientationMode int orientation, int decoration, @ColorInt int color, int lineSize) {
